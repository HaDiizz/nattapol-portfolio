...
export const sideProjects = [
  {
    ...
    description: "A utility hub for Next.js developers — code snippets, config templates, and workflow tools to accelerate development.",
  ...
  },
  {
    ...
    description: "A real-time web application featuring websockets, PWA capabilities, and scalable infrastructure.",
    url: "https://woopify.vercel.app/",
    github: null,
    tags: ["Next.js", "Tailwind CSS", "Shadcn UI", "TypeScript", "Express", "Socket.io", "PWA", "Cloudflare Workers", "MongoDB"],
    status: "live",
    image: {
  ...
  },
  {
    ...
    description: "A Retrieval-Augmented Generation (RAG) search platform with team collaboration, user profiles, and document management. Built with vector embeddings and LLM integration.",
    url: null,
    github: null,
    tags: ["Next.js", "Tailwind CSS", "Shadcn UI", "TypeScript", "FastAPI", "Llama CPP", "PostgreSQL", "RAG", "Magic UI", "Redis"],
    status: "private",
    features: ["Team workspaces", "User profiles", "Document ingestion", "Semantic search"],
    image: {
