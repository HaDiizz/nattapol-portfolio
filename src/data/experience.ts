export const experience = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        tags: ['Vue 3', 'Vuetify', 'Express', 'Health Platform'],
      ...
      },
      {
        ...
        tags: ['Angular', 'NG-ZORRO', 'Go', 'Health Platform'],
      ...
      },
      {
        ...
        tags: ['Next.js', 'E-Signature', 'B2B', 'B2C'],
      },
      {
        name: 'ID Connect',
        ...
        tags: ['Next.js', 'OIDC', 'SAML', 'SSO', 'Azure AD'],
        url: 'https://idconnect.one.th',
      },
      {
        name: 'One Authorized',
        ...
        tags: ['Angular', 'ONE ID', 'Identity Federation', 'User Management'],
      },
    ],
  },
  {
    ...
    type: 'freelance',
    description:
      'Designed and deployed a full backend for a multi-role travel booking and referral platform.',
    projects: [
      {
  ...
  },
  {
    ...
    type: 'freelance',
    description:
      'Built a school management system frontend from Figma designs.',
    projects: [
      {
  ...
  },
  {
    ...
    type: 'internship',
    description:
      'Full-stack development and automated testing across CMS and translation platforms.',
    projects: [
      {
        name: 'AOT CMS Portal',
